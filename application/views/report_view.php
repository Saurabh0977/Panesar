				...
				<table class="table datatable-show-all">
					...
					<tr>
						<form method="POST" target="_blank" id = "form1" action="<?php echo base_url();?>/Report/create_report/1">
							...
							<td class="text-center">
								...
								<button type = "button" class="btn btn-primary" onclick="submit(1)" name="download" value="download"><i class="icon-download4"></i></button>
							</td>
						</form>
					</tr>
					<tr>
						<form method="POST" target="_blank" id = "form2" action="<?php echo base_url();?>/Report/create_report/2">
							...
							<td class="text-center">
								<button type="submit" class="btn btn-primary" name="preview"><i class="icon-eye"></i></button>
								<button type = "button" class="btn btn-primary" onclick="submit(2)" name="download" value="download"><i class="icon-download4"></i></button>
							</td>
						</form>
					</tr>
					...
					<tr>
						<form method="POST" target="_blank" id = "form3" action="<?php echo base_url();?>/Report/create_report/3">
							...
							<td class="text-center">
								<button type="submit" class="btn btn-primary" name="preview"><i class="icon-eye"></i></button>
								<button type = "button" class="btn btn-primary" onclick="submit(3)" name="download" value="download"><i class="icon-download4"></i></button>
							</td>
						</form>
					</tr>
				</table>
