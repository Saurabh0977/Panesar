...
class Model_items extends CI_Model
{
	...
	public function update_item_details_with_photo($id,$iname,$unit,$color,$newname,$mthreshold)
	{
		$this->load->database();
		$query = $this->db->query("UPDATE `item_list` SET `NAME`='$iname',`UNIT`='$unit',`COLOR`='$color',`PHOTO` = '$newname',`MIN_THRESHOLD`='$mthreshold' WHERE ID = '$id'");
